...
class PromotionsServiceImplTest {
    ...
    void getAllPromotionsByOrderByCreateAt() {
        ...
        List<PromotionResponse> responses = List.of(
                PromotionResponse.builder().id(1L).name("123").build(),
                PromotionResponse.builder().id(2L).name("5435").build()
        );
    ...
    void getPromotionDto() {
        ...
        promotion.setId(1L);
        PromotionResponse expectedResponse = PromotionResponse.builder().id(1L).name("Bober").image("bober").build();
    ...
    void savePromotion() throws Exception {
        ...
        when(productService.getProduct(request.getProductId())).thenReturn(product);
    ...
    void updatePromotionById() throws Exception {
        ...
        when(productService.getProduct(request.getProductId())).thenReturn(product);
        when(promotionRepository.findById(request.getId())).thenReturn(Optional.of(promotion));
